...
public class ProxyServer extends ProxyCommon {
	...
	public void registerRecipes() {
		...
		GameRegistry.addRecipe(jumpBoots, "B", "S", 'S', Blocks.SLIME_BLOCK, 'B', Items.LEATHER_BOOTS);
		...
		GameRegistry.addRecipe(climbClaws, "S S", "C C", 'S', Items.SPIDER_EYE, 'C', Items.SHEARS);
	}
}

...
public class ProxyServer extends ProxyCommon {
	...
	public void registerRecipes() {
		...
		if (Config.climbeyEnabled) {
			...
			GameRegistry.addShapedRecipe(jumpBoots, "B", "S", 'S', Blocks.SLIME_BLOCK, 'B', Items.LEATHER_BOOTS);
			...
			GameRegistry.addShapedRecipe(climbClaws, "S S", "C C", 'S', Items.SPIDER_EYE, 'C', Items.SHEARS);
		}
	}
}
